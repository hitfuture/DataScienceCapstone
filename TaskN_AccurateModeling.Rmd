---
title: "Build Accurate Modeling System"
author: "Brett Taylor"
date: "Jan 1, 2016"
...
blogsTermMap <- buildTermMap("./data/en_US.blogs.txt")
twitterTermMap<- buildTermMap("./data/en_US.twitter.txt")
newsTermMap<- buildTermMap("./data/en_US.news.txt")
...
```{r blogCloud,warning=FALSE,eval=TRUE}
...
```{r newsCloud,warning=FALSE,eval=TRUE}
map <- newsTermMap
tdmap1  <- buildUnigramMap(map)
tdmap2  <- buildBigramMap(map)
tdmap3 <- buildTrigramMap(map)
